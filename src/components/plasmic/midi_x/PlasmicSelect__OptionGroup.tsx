...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: shfBYW_Ixy_/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: mKhxhGuxUJn/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___6VpB)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__t8CXs)}
              />
            </React.Fragment>
          ),
          value: args.children
